...
(function(exports, _) {
  ...
  function start () {
    if (!this.isStarted()) {
      ...
      // QUESTION 1: should this only be called if you have an interval?
      // QUESTION 2: should this be called immediately, or on a timeout?
      tick.call(this);

      if (Infinity !== this._endsAt) {
        setTimeout(_.bind(end, this), this._endsAt - now);
      }
    }
  }
