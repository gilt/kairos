...
(function (exports, privateKey) {
  ...
  function create (_, errors) {
    ...
    _.extend(KairosTimeFrame.prototype, {
      ...
      /**
       * Gets the millisecond value (or the original value) of the 'relativeTo'
       * property.
       *
       * @public
      ...
      /**
       * Sets the 'relativeTo' property. Will throw an error if start has already
       * been called.
       *
       * @public
      ...
      /**
       * Gets the current duration relative to the 'relativeTo' time.
       *
       * @public
...
(function (exports, privateKey) {
  ...
  if ('function' === typeof define && define.amd) {
    ...
    exports.KairosCollection = create(
      ('function' === typeof require && require('underscore'))        || exports._               || _,
      ('function' === typeof require && require('kairos_time_frame')) || exports.KairosTimeFrame || KairosTimeFrame,
      ('function' === typeof require && require('kairos_errors'))     || exports.KairosErrors    || KairosErrors
    );
  }
}(
